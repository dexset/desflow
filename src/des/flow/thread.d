...
private
{
    ...
    final class WorkProcessor(Args...) : ExternalMemoryManager, CtrlSignalProcessor, EventProcessor
    {
        mixin EMM;
        ...
        // SignalProcessor
        void processCtrlSignal( in CtrlSignal sig ) { com.signals.pushBack(sig); }
        ...
        void init()
        {
            ...
            elem.setCtrlSignalProcessor( this );
